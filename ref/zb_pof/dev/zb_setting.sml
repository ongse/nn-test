...
<CORE_DATA=1,6,7777777,99,8>		//no, data count(dword), data type(32-bit Hex/random/zero/one), FT(hex), segmentation(8/16/32)
<CORE_DATA=2,8,8888888,80,8>
<CORE_DATA=3,6,9999999,17,8>
<CORE_SWITCH=16,16>					//switch region (dword count), segmentation(8/16/32)
<CORE_DATA=4,9,aaaaaaaa,31,16>
<CORE_DATA=5,10,bbbbbbb,40,16>
<CORE_DATA=6,9,cccccccc,27,16>

<POST_AMBLE=59>						//number of post amble (dword count)
